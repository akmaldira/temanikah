...
module.exports = class Migration1692457093261 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "subscriptions" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "features" text array NOT NULL, CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vouchers" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "code" character varying NOT NULL, "discount" numeric(10,2) NOT NULL, "min_price" numeric(10,2) NOT NULL, "stock" integer NOT NULL, "expired_at" TIMESTAMP NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "description" character varying, CONSTRAINT "PK_ed1b7dd909a696560763acdbc04" PRIMARY KEY ("id"))`);
