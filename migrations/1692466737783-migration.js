...
module.exports = class Migration1692466737783 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "duration" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "subscription_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "voucher_id" integer`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_e9acc6efa76de013e8c1553ed2b"`);
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "user_id" SET NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_e9acc6efa76de013e8c1553ed2b"`);
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "user_id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_e9acc6efa76de013e8c1553ed2b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
